...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    url = 'https://www.glassdoor.com/Job/jobs.htm?sc.keyword="'+keyword+'"data%20analyst&suggestCount=0&suggestChosen=false&clickSource=searchBox&locId=115&locT=N&locName=India'
    driver.get(url)
    jobs = []
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        try:
            ...
            print('Tilllllllll hereeeeeeee')  #clicking to the X.
        except NoSuchElementException:
            print("YYYYYYYYYYYooooooooooooooooo!!!!")
            pass
